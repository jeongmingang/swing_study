...
//				System.out.println(e.getActionCommand()); //어떤버튼 눌렸는지 구분가능
		...
		panel_2 = new JPanel();
		panel_2.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "JMenu & JPopupMenu", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		panel_4 = new JPanel();
		panel_4.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "JFileChooser", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
